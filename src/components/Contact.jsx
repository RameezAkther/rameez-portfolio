  ...
  return (
    <section className="section" id='contact'>
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/bzynrena" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              <label htmlFor="name" className='label reveal-up'>Name</label>
              <input type="text" name='name' id="name" autoComplete='name' placeholder='nice person' required className="text-field reveal-up" />
            </div>
            <div className="mb-4">
              <label htmlFor="email" className='label reveal-up'>Email</label>
              <input type="email" name='email' id="email" autoComplete='email' placeholder='niceperson@example.com' required className="text-field reveal-up" />
            </div>
          </div>

          <div className="mb-4">
            <label htmlFor="message" className="label reveal-up">Message</label>
            <textarea name="message" id="message" className='text-field resize-y min-h-32 max-h-80 reveal-up' placeholder='Hello!' required></textarea>
          </div>

          <button className="btn btn-primary [&]:max-w-full w-full justify-center reveal-up" type='submit'>Submit</button>
        </form>
      </div>
    </section>
  )
